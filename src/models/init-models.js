...
import _comment_table from  "./comment_table.js";
...
export default function initModels(sequelize) {
  const comment_table = _comment_table.init(sequelize, DataTypes);
  ...
  comment_table.belongsTo(restaurant, { as: "re", foreignKey: "res_id"});
  restaurant.hasMany(comment_table, { as: "comment_tables", foreignKey: "res_id"});
  ...
  comment_table.belongsTo(users, { as: "user", foreignKey: "user_id"});
  users.hasMany(comment_table, { as: "comment_tables", foreignKey: "user_id"});
